...
<link rel="StyleSheet" type="text/css" href="<%=basePath %>js/bootstrap-3.3.7-dist/css/bootstrap-datetimepicker.min.css">
...
<script type="text/javascript" src="<%=basePath %>js/bootstrap-3.3.7-dist/js/bootstrap-paginator.js"></script>
<script type="text/javascript" src="<%=basePath %>js/bootstrap-3.3.7-dist/js/bootstrap-datetimepicker.js"></script>
<script type="text/javascript" src="<%=basePath %>js/bootstrap-3.3.7-dist/js/bootstrap-datetimepicker.fr.js" charset="UTF-8"></script>
